...
这里使用的网络方案为 Calico 因此 `--pod-network-cidr` 等于  `10.244.0.0/16` 更多网络方案点击[这里](https://kubernetes.io/docs/concepts/cluster-administration/addons/)
